...
- **Помилки з email**: Переконайтеся, що налаштування SMTP в .env файлі коректні. Для Gmail потрібно використовувати пароль додатку.
- **Проблеми з Cloudinary**: Перевірте правильність облікових даних Cloudinary в .env файлі.
- **Rate Limiter**: У разі частих запитів може спрацьовувати обмеження кількості запитів. Зачекайте кілька хвилин перед повторною спробою.

---

## Поради з використання

- **Безпека паролів**: Використовуйте сильні паролі, система підтримує хешування для захисту ваших даних.
- **Багатофакторна аутентифікація**: Використовуйте підтвердження email для підвищення безпеки облікового запису.
- **Аватари**: Завантажуйте аватари у форматах JPEG, PNG або GIF з розміром не більше 5 МБ.
- **Організація контактів**: Використовуйте групи для ефективного управління контактами.

---

## Ліцензія

Цей проєкт доступний за відкритим доступом.

---

*Створено з Python та FastAPI ❤️*
